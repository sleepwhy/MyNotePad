...
internal class CodeTyperCPP
{
    private RichTextBox textBox;

    // Constructor: RichTextBox'u alır ve renklendirme işlemini başlatır
    public CodeTyperCPP(RichTextBox richTextBox)
    {
    ...
    {
        string[] keywords = {
            "public", "private", "protected", "class", "void", "int", "float",
            "char", "double", "bool", "for", "while", "if", "else", "switch",
            "case", "return", "new", "try", "catch", "throw", "virtual", "friend",
            "inline", "static", "const", "struct", "enum", "namespace", "this"
        };
    ...
    {
        string variablePattern = @"\b(int|float|double|char|bool)\s+\w+\b"; // Değişkenler (tip + isim)
    ...
    // Yorumları renklendir (Tek satırlık ve çok satırlı)
